        ...
        >
          <div className="job-box-header flexbox justify-space-between">
            <div className="job-box-title">
              <div className="post-date">{moment(created_at).fromNow()}</div>
          ...
          <div className="job-box-body">
            <div className="job-box-tips flexbox justify-space-between">
              ...
              <div className="tip">
                ...
                <span className="text">
                  {commitment === 'per_week_more_than_30'
                    ? '>30h'
              ...
              <div className="tip">
                ...
                <span className="text">{(period || '') + (period_type ? period_type.toUpperCase()[0] : 'N/A')}</span>
              </div>
            ...
            <div className="job-box-deskr" style={{ height: '100px' }}>
              ...
              <div className="skill-tags-block clearfix">{/* <div className="skill-tag">HTML5</div> */}</div>
            </div>
          </div>
        ...
        <div className="panel panel-default job-box-details" style={styleForModal}>
          ...
          <div className="flexbox justify-space-between">
            <div className="about-block-wrapper">
              ...
              <div className="info-block">
                <div className="title">{`${user.skill_test_send} Skill test / ${user.total_jobs} jobs`}</div>
              </div>
              <div className="info-block">
              ...
              <div className="info-block">
                ...
                <div className="text">{user.place_to_work ? user.place_to_work : ''}</div>
              </div>
                ...
                <div className="stat flexbox justify-space-center flex-wrap">
                  ...
                  <div className="stat-block">
                    ...
                    <span className="stat-info">
                      `${period || ''} ${period_type ? period_type.toUpperCase()[0] : 'N/A'}` }
                    </span>
                  </div>
                </div>
              </div>

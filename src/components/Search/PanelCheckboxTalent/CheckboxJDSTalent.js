  ...
  render() {
    ...
    return (
      <div className="filter-block">
        <div className="filter-title">Job Done Success:</div>
        <div className="checkbox-list-block clearfix">
          <div className="checkbox-block">
            <input
              ...
              type="checkbox"
              id="checkbox-2.1"
              checked={inputData[this.state.queryParamKey] ? inputData[this.state.queryParamKey] === 'i_100' : false}
              onChange={event => {
          ...
          <div className="checkbox-block">
            <input
              ...
              type="checkbox"
              id="checkbox-2.2"
              checked={inputData[this.state.queryParamKey] ? inputData[this.state.queryParamKey] === 'm_95' : false}
              onChange={event => {
                changeCheckboxDataSingle(this.state.queryParamKey, inputData, event);
              }}
            />
          ...
          <div className="checkbox-block">
            <input
              ...
              type="checkbox"
              id="checkbox-2.3"
              checked={inputData[this.state.queryParamKey] ? inputData[this.state.queryParamKey] === 'i_85_95' : false}
              onChange={event => {
                changeCheckboxDataSingle(this.state.queryParamKey, inputData, event);
              }}
            />
          ...
          <div className="checkbox-block">
            <input
              ...
              type="checkbox"
              id="checkbox-2.4"
              checked={inputData[this.state.queryParamKey] ? inputData[this.state.queryParamKey] === 'l_85' : false}
              onChange={event => {
                changeCheckboxDataSingle(this.state.queryParamKey, inputData, event);
              }}
            />

              ...
              <div className="checkbox-list-block">
                  ...
                  <input
                    checked={
                      inputData[this.state.queryParamKey]
                        ? inputData[this.state.queryParamKey].indexOf('i0_100') >= 0
                        : false
                    }
                    name="i0_100"
                    type="checkbox"
                ...
                <div className="checkbox-block">
                  <input
                    checked={
                      inputData[this.state.queryParamKey]
                        ? inputData[this.state.queryParamKey].indexOf('i100_300') >= 0
                        : false
                    }
                    name="i100_300"
                    type="checkbox"
                ...
                <div className="checkbox-block">
                  <input
                    checked={
                      inputData[this.state.queryParamKey]
                        ? inputData[this.state.queryParamKey].indexOf('i300_1000') >= 0
                        : false
                    }
                    name="i300_1000"
                    type="checkbox"
                ...
                <div className="checkbox-block">
                  <input
                    checked={
                      inputData[this.state.queryParamKey]
                        ? inputData[this.state.queryParamKey].indexOf('more_1000') >= 0
                        : false
                    }
                    name="more_1000"
                    type="checkbox"

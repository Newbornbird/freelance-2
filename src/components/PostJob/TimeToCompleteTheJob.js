    ...
    return (
      <div className="form-block-section job-time-block col-100">
        <div className="form-block-header">
          <div className="form-block-title">Estimated time to complete the Job</div>
        </div>
              ...
              <span className="my-select-result" onClick={togglePeriodTypeList}>
                <span className="text">
                  {requestForPostJob.period > 1
                    ? `${requestForPostJob.period_type.toUpperCase()}S`
                    : requestForPostJob.period_type.toUpperCase()}
                </span>

...
class TalentCommitment extends Component {
  render() {
    const { requestForPostJob, changeCheckboxForPostJob } = this.props;
    return (
      <div className="form-block-section col-30">
        <div className="form-block-header">
          <div className="form-block-title">Talent Commitment</div>
        </div>
        <div className="radio-block">
          <div className="radio">
            <input
              ...
              onChange={event => {
                changeCheckboxForPostJob(event, 'commitment');
              }}
            />
            <label htmlFor="later">

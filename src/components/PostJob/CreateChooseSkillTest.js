        ...
        <div className='form-block-wrapper promo-sample-block'>
          <div className='radio-block'>
            ...
            <div className='post-job-inputs'>
              <span style={statusPostJob.createSkillTest ? { color: 'red' } : { display: 'none' }}>
              ...
              <textarea
                ...
                value={
                  statusPostJob.createSkillTest ? requestForPostJob.promotion_description : 'Skill Test Description'
                }
          ...
          <div className='radio-block'>
            ...
            <span
              style={
                !requestForPostJob.promotion_title && !statusPostJob.createSkillTest
                  ? { color: 'red' }
                  : { display: 'none' }
              }
            >
            ...
            <div className='promo-block-form'>
              <div className='promo-block-form-header flexbox justify-space-between'>
                <div className='filter-nav flexbox justify-space-between'>
                  <div className={promotionList ? 'my-select-box form-control open' : 'my-select-box form-control'}>
                      ...
                      <div className='radio-block'>
                        {statusPostJob.activePromotionCategory
                          ? promotions.categories
                              .find(category => category.name === statusPostJob.activePromotionCategory)
                  ...
                  <span className='numb'>
                    {statusPostJob.activePromotionCategory
                      ? promotions.promotions.filter(
                          promotion => promotion.title === statusPostJob.activePromotionCategory,
                        ).length
              ...
              <div className='promo-block-form-body'>
                {statusPostJob.activePromotionCategory
                  ? promotions.promotions
                      ...
                      .map((prom, index) => (
                        <div className='checkbox-block' key={index}>
                          <input type='checkbox' id={`skill-test-${index}`} value={prom.id} />
                          <label
                            ...
                            <div className='panel-block flexbox'>
                              <span className='checkbox-circle checkbox-sqw'>
                                <span
                                  ...
                                  style={
                                    requestForPostJob.promotion.id === prom.id
                                      ? { visibility: 'visible', fontSize: '10px' }
                                      : { visibility: 'hidden' }
                                  }
                                />
                              </span>
                                ...
                                <div
                                  ...
                                  style={
                                    (index + 1) % 3
                                      ? (index + 1) % 2
                                        ? { width: '500px' }
                                        : { width: '500px', backgroundColor: '#ffeecd' }
                                      : { width: '500px', backgroundColor: '#fae2ff' }
                                  }
                                >
                  ...
                  : promotions.promotions.map((prom, index) => (
                      <div className='checkbox-block' key={index}>
                        <input value={prom.id} type='checkbox' id={`skill-test-${index}`} />
                        <label
                          htmlFor={'skill-test-' + index}
                          onClick={() => {
                            choosePromotion(prom.id, requestForPostJob.promotion.id, promotions.promotions);

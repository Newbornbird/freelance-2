...
class Step1 extends Component {
  render() {
    const { usersSkills, addingSkillsStatus, goToTheNextStep, chooseCategoryForSkills } = this.props;
    return (
      <div className="step-1">
        <div className="skill-block skill-cat">
          ...
          <div className="skill-block-list">
            <form>
              {usersSkills[0]
                ? usersSkills.map((category, index) => (
                    <div className="checkbox-block" key={index}>
                      <input
                        ...
                        onChange={event => {
                          chooseCategoryForSkills(event, category.id);
                        }}
                      />
          ...
          <button
            ...
            onClick={() => {
              goToTheNextStep(addingSkillsStatus.step);
            }}
          >
            > Next
          </button>

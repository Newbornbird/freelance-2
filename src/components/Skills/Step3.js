    ...
    return (
      <div className="step-3">
            ...
            <div className="skill-subcat skill-subcat--item" key={ skill.id }>
              <div className="flexbox justify-space-between">
                ...
                <div className="skill-sub-block">
                  <div style={ { display: 'block' } } className="skill-block-title">Skills</div>
                  <div className="skill-tags-block clearfix">
                    { skill.skill_tags.length ? skill.skill_tags.map ( 
                        skill_tag => ( <div key={ skill_tag.id } className="skill-tag">{skill_tag.name}</div> ) ) : '' }
                  </div>
                </div>
              </div>
        ...
        <div className="skill-subcat skill-subcat--new">
          ...
          <button type="button" className="btn btn-blue add-skill-btn">Add Skill Category</button>
        </div>
